...
# Original repository https://github.com/jakubcerveny/gilbert
...
if __name__ == "__main__":
    ...
    parser.add_argument('pcb_width', type=int)
    parser.add_argument('pcb_height', type=int)
    args = parser.parse_args()

    points = list(gilbert2d(args.num_points_x, args.num_points_y))
    x_axis = [k[0] for k in points]
    y_axis = [k[1] for k in points]
